...
import com.fouche.webwarrantymanager.services.unit.DisplayUnitsWithUserIdService;
 ...
 */
@Service
public class DisplayUnitsWithUserIdServiceImpl implements DisplayUnitsWithUserIdService{
    @Autowired

...
import com.fouche.webwarrantymanager.services.retailers.DisplayRetailersWithIdService;
 ...
 */
@Service
public class DisplayRetailersWithIdServiceImpl implements DisplayRetailersWithIdService{
    @Autowired
